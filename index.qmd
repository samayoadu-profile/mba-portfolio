...
format:
  html:
    theme: cosmo  # Other options: journal, minty, flatly, simplex, darkly, etc.
    toc: true     # Table of contents (optional)
    smooth-scroll: true
    css: styles.css  # For custom styling (optional)
    code-fold: false
    page-layout: full
---
...
# ![](profile.jpg){width=150px}

---

```{=html}
<!-- This section will be visible only if you host it correctly -->
<p style="text-align:center; font-size: 0.9em; color: #aaa;">&copy; 2025 Ayooluwa Adu. All rights reserved.</p>
